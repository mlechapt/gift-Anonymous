...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'gift_homepage');
            }
        ...
        // gift_myAccount
        if ($pathinfo === '/my-account') {
            return array (  '_controller' => 'giftBundle\\Controller\\DefaultController::myAccountAction',  '_route' => 'gift_myAccount',);
        }
        ...
        if ($pathinfo === '/profiles/change-password') {
            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
